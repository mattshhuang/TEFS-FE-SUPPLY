(function (a, m) {
  ...
  function s (g, v, a) {
    if (void 0 === a && 1 === g.nodeType) if (a = "data-" + v.replace(Wc, "-$1").toLowerCase(), a = g.getAttribute(a), "string" === typeof a) {
      try {
  ...
  function u (g) {
    for (var a in g) if (!("data" === a && f.isEmptyObject(g[a])) && "toJSON" !== a) return !1;
    return !0
  }

  function b (g, a, p, K) {
    if (f.acceptData(g)) {
      var b = f.expando, c = g.nodeType, d = c ? f.cache : g, n =
          c ? g[b] : g[b] && b;
  ...
  function c (g, a, p) {
    if (f.acceptData(g)) {
      var K, b, c = g.nodeType, k = c ? f.cache : g, d = c ? g[f.expando] : f.expando;
      if (k[d]) {
        if (a &&
            (K = p ? k[d] : k[d].data)) {
  ...
  function Fa (g, a) {
    if (1 === a.nodeType && f.hasData(g)) {
      var p, K, b;
      K = f._data(g);
      var c = f._data(a, K), k = K.events;
      if (k) for (p in delete c.handle, c.events = {}, k) {
        K = 0;
  ...
  function fb (g,
    ...
    return {
      get: function () {
        var p = g();
        if (null != p) if (p) delete this.get; else return (this.get = a).apply(this, arguments)
      }
    }
  }
  ...
  function gb (g, a) {
    if (a in g) return a;
    for (var p = a.charAt(0).toUpperCase() + a.slice(1), b = a, f = oc.length; f--;) if (a = oc[f] + p, a in g) return a;
    return b
  }
  ...
  function va (g, a) {
    ...
    for (d = 0; d < n; d++) if (b = g[d], b.style && (!a || "none" === b.style.display || "" === b.style.display)) b.style.display = a ? k[d] || "" : "none";
    return g
  }
  ...
  function aa (g, a, p) {
    var b = !0, c = "width" === a ? g.offsetWidth : g.offsetHeight, k = Ra(g),
  ...
  function wa (g, a, p) {
    for (var b, f = (ib[a] || []).concat(ib["*"]), c = 0, k = f.length; c < k; c++) if (b = f[c].call(p, a, g)) return b
  }
  ...
  function jb (g, a, p) {
    var b, c, k = 0, d = tb.length, n = f.Deferred().always(function () {
      ...
      stop: function (a) {
        var v = 0, p = a ? r.tweens.length : 0;
        if (c) return this;
        for (c =
                 !0; v < p; v++) r.tweens[v].run(1);
    ...
    var h, q, l, j;
    for (b in a) if (h = f.camelCase(b), q = p[h], l = a[b], f.isArray(l) && (q = l[1], l = a[b] = l[0]), b !== h && (a[h] = l, delete a[b]), (j = f.cssHooks[h]) && "expand" in j) for (b in l = j.expand(l), delete a[h], l) b in a || (a[b] = l[b], p[b] = q); else p[h] = q;
  ...
  function kb (g) {
    return function (a, p) {
      ...
      var b, c = 0, k = a.toLowerCase().match(xa) || [];
      if (f.isFunction(p)) for (; b = k[c++];) "+" === b.charAt(0) ? (b = b.slice(1) || "*", (g[b] = g[b] || []).unshift(p)) : (g[b] = g[b] || []).push(p)
    }
  }
  ...
  function na (g, a, p, b) {
    ...
    }); else if (!p && "object" === f.type(a)) for (c in a) na(g + "[" + c + "]", a[c], p, b); else b(g, a)
  }
  ...
  var k = [], n = k.slice, r = k.concat, z = k.push, F = k.indexOf, P = {}, bd = P.toString, za = P.hasOwnProperty,
      Ob = "".trim, w = {}, f = function (g, a) {
        return new f.fn.init(g, a)
      }, cd = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, dd = /^-ms-/, ed = /-([\da-z])/gi, fd = function (g, a) {
  ...
  f.extend = f.fn.extend = function () {
    ...
    d === n && (k = this, d--);
    for (; d < n; d++) if (null != (c = arguments[d])) for (b in c) g = k[b], p = c[b], k !== p && (e && p && (f.isPlainObject(p) || (a = f.isArray(p))) ? (a ?
        (a = !1, g = g && f.isArray(g) ? g : []) : g = g && f.isPlainObject(g) ? g : {}, k[b] = f.extend(e, g, p)) : void 0 !== p && (k[b] = p));
    return k
  };
  f.extend({
    expando: "jQuery" + ("1.11.0" + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (g) {
      throw Error(g);
    }, noop: function () {
      ...
      b = l(g);
      if (p) if (b) for (; f < c && !(b = a.apply(g[f], p), !1 === b); f++) ; else for (f in g) {
        if (b = a.apply(g[f], p), !1 === b) break
      } else if (b) for (; f < c && !(b = a.call(g[f], f, g[f]), !1 === b); f++) ; else for (f in g) if (b = a.call(g[f], f, g[f]), !1 === b) break;
      return g
      ...
      if (a) {
        ...
        b = a.length;
        for (p = p ? 0 > p ? Math.max(0, b + p) : p : 0; p < b; p++) if (p in a && a[p] === g) return p
      }
      return -1
    }, merge: function (g, a) {
      ...
      if (l(g)) for (; f < c; f++) b = a(g[f], f, p), null != b && k.push(b); else for (f in g) b = a(g[f], f, p), null != b && k.push(b);
      return r.apply([], k)
    }, guid: 1, proxy: function (g, a) {
      var p, b;
  ...
  var Pb = a, D = function (g, a, p, b) {
        ...
        if (X && !b) {
          if (f = gd.exec(g)) if (k = f[1]) if (9 === d) if ((c = a.getElementById(k)) && c.parentNode) {
        ...
        a:{
          ...
          if (!b && 1 === c.length) {
            ...
            for (d = xb.needsContext.test(g) ? 0 : f.length; d--;) {
              ...
              if (k = G.find[k]) if (b = k(r.matches[0].replace(Ha, Ia), Qb.test(f[0].type) &&
                  ha(a.parentNode) || a)) {
                f.splice(d, 1);
                g = b.length && vb(f);
                if (!g) {
        ...
        var p = a && g, b = p && 1 === g.nodeType && 1 === a.nodeType && (~a.sourceIndex || ia) - (~g.sourceIndex || ia);
        if (b) return b;
        ...
        return pa(function (a) {
          ...
          return pa(function (p, b) {
            for (var f, c = g([], p.length, a), k = c.length; k--;) if (p[f =
                c[k]]) p[f] = !(b[f] = p[f])
          })
        })
      }, ha = function (g) {
        ...
        for (n = G.preFilter; k;) {
          ...
          p = !1;
          if (b = ld.exec(k)) p = b.shift(), f.push({value: p, type: b[0].replace(wb, " ")}), k = k.slice(p.length);
          for (c in G.filter) if ((b = xb[c].exec(k)) && (!n[c] || (b = n[c](b)))) p = b.shift(), f.push({
            value: p,
            type: c,
            matches: b
          }), k = k.slice(p.length);
        ...
        var b = a.dir, f = p && "parentNode" === b, c = md++;
        return a.first ? function (a, p, v) {
          ...
          } else for (; a = a[b];) if (1 === a.nodeType || f) {
            d = a[M] || (a[M] = {});
        ...
        for (var c, k = [], d = 0, n = g.length, e = null != a; d < n; d++) if (c = g[d]) if (!p || p(c, b, f)) k.push(c), e && a.push(d);
        return k
      }, Vb = function (g, a, p, b, f, c) {
        b && !b[M] && (b = Vb(b));
        f && !f[M] && (f = Vb(f, c));
        return pa(function (c, k, d, n) {
          var e, r, fa = [], h = [], l = k.length, q;
          if (!(q = c)) {
            q = a || "*";
          ...
          if (c) {
            if (f || g) {
              ...
              for (d = j.length; d--;) if ((r = j[d]) && -1 < (e = f ? Ua.call(c, r) : fa[d])) c[e] = !(k[e] = r)
            }
          } else j = Ta(j === k ? j.splice(l, j.length) : j), f ? f(null, k, j, n) : Ga.apply(k, j)
        })
      }, Wb = function (g) {
        var a, p, b, f = g.length, c = G.relative[g[0].type];
        p = c || G.relative[" "];
        ...
        }]; k < f; k++) if (p = G.relative[g[k].type]) e = [Tb(Ub(e), p)]; else {
          p = G.filter[g[k].type].apply(null, g[k].matches);
          if (p[M]) {
            for (b = ++k; b < f && !G.relative[g[b].type]; b++) ;
            return Vb(1 < k && Ub(e), 1 < k && vb(g.slice(0, k - 1).concat({value: " " === g[k - 2].type ? "*" : ""})).replace(wb, "$1"), p, k < b && Wb(g.slice(k, b)), b < f && Wb(g = g.slice(b)), b < f && vb(g))
          }
          e.push(p)
        }
        return Ub(e)
      }, Ba, H, G, Ka, rc, $a, Aa, ra, Ca, oa, R, ja, X, S, da, La, sa, M = "sizzle" + -new Date,
      W = Pb.document, ca = 0, md = 0, sc = Rb(), Ja = Rb(), Da = Rb(), A = function (g, a) {
        g === a && (Ca = !0);
        return 0
      }, T = "undefined", ia = -2147483648, ea = {}.hasOwnProperty, N = [], Y = N.pop, nd = N.push, Ga = N.push,
      tc = N.slice, Ua = N.indexOf || function (g) {
        for (var a = 0, p = this.length; a < p; a++) if (this[a] === g) return a;
        return -1
      ...
      qd = RegExp("^" + uc + "$"), xb = {
        ...
        needsContext: RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)",
            "i")
      }, rd = /^(?:input|select|textarea|button)$/i, sd = /^h\d$/i, lb = /^[^{]+\{\s*\[native \w/,
      gd = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Qb = /[+~]/, hd = /'|\\/g,
      Ha = RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)", "ig"), Ia = function (g, a, p) {
        g = "0x" + a - 65536;
  ...
  oa = D.setDocument = function (g) {
    ...
    G.find.TAG = H.getElementsByTagName ? function (g, a) {
      ...
      var b,
          v = [], f = 0, c = a.getElementsByTagName(g);
      if ("*" === g) {
    ...
    sa = (g = lb.test(ja.compareDocumentPosition)) || lb.test(ja.contains) ? function (g, a) {
      var b = 9 === g.nodeType ? g.documentElement : g, v = a && a.parentNode;
  ...
  D.attr = function (g, a) {
    (g.ownerDocument || g) !== R && oa(g);
    var b = G.attrHandle[a.toLowerCase()], b = b && ea.call(G.attrHandle, a.toLowerCase()) ? b(g, a, !X) : void 0;
  ...
  Ka = D.getText = function (g) {
    var a, b = "", f = 0;
    if (a = g.nodeType) if (1 === a || 9 === a || 11 === a) {
  ...
  G = D.selectors = {
    cacheLength: 50, createPseudo: pa, match: xb, attrHandle: {}, find: {}, relative: {
      ...
      ATTR: function (g) {
        ...
        if (g[3] && void 0 !== g[4]) g[2] = g[4]; else if (b && pd.test(b) && (a = ta(b, !0)) && (a = b.indexOf(")", b.length - a) - b.length)) g[0] = g[0].slice(0, a), g[2] = b.slice(0, a);
        return g.slice(0, 3)
      }
    }, filter: {
      TAG: function (g) {
        ...
        var k = "nth" !== g.slice(0, 3), d = "last" !== g.slice(-4), n = "of-type" === a;
        return 1 === f && 0 === c ? function (g) {
            ...
            function (a, b, p) {
              ...
              var j = a.parentNode, l = n && a.nodeName.toLowerCase();
              p = !p && !n;
              if (j) {
                if (k) {
                  for (; b;) {
                    for (e = a; e = e[b];) if (n ? e.nodeName.toLowerCase() === l : 1 === e.nodeType) return !1;
                ...
                if (d && p) {
                  ...
                  h = v[0] === ca && v[1];
                  r = v[0] === ca && v[2];
                  for (e = h && j.childNodes[h]; e = ++h && e && e[b] || (r = h = 0) || q.pop();) if (1 === e.nodeType && ++r && e === a) {
                    p[g] = [ca, h, r];
                    break
                  }
                } else if (p && (v = (a[M] ||
                    (a[M] = {}))[g]) && v[0] === ca) r = v[1]; else for (; e = ++h && e && e[b] || (r = h = 0) || q.pop();) if ((n ? e.nodeName.toLowerCase() === l : 1 === e.nodeType) && ++r) if (p && ((e[M] || (e[M] = {}))[g] = [ca, r]), e === a) break;
                r -= c;
      ...
      not: pa(function (g) {
        ...
        return function (a) {
          var b;
          do if (b = X ? a.lang : a.getAttribute("xml:lang") || a.getAttribute("lang")) return b = b.toLowerCase(), b === g || 0 === b.indexOf(g + "-"); while ((a = a.parentNode) && 1 === a.nodeType);
          return !1
        }
      }), target: function (g) {
        ...
        for (g = g.firstChild; g; g = g.nextSibling) if (6 > g.nodeType) return !1;
        return !0
      }, parent: function (g) {
  ...
  for (Ba in {radio: !0, checkbox: !0, file: !0, password: !0, image: !0}) G.pseudos[Ba] = id(Ba);
  for (Ba in {submit: !0, reset: !0}) G.pseudos[Ba] = jd(Ba);
  ...
  $a = D.compile = function (g, a) {
    ...
    if (!k) {
      ...
      var d = 0 < f.length, n = 0 < c.length;
      b = function (g, a, b, p, v) {
        var k, e, r, h = 0, fa = "0", j = g && [], q = [], l = Aa, A = g || n && G.find.TAG("*",
            v), z = ca += null == l ? 1 : Math.random() || 0.1, T = A.length;
        for (v && (Aa = a !== R && a); fa !== T && null != (k = A[fa]); fa++) {
          if (n && k) {
            for (e = 0; r = c[e++];) if (r(k, a, b)) {
              p.push(k);
              break
            }
            v && (ca = z)
  ...
  var wc = f.expr.match.needsContext, xc = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Vc =
      /^.[^:#\[\.,]*$/;
  ...
  mb = f(y);
  var ud = /^(?:parents|prev(?:Until|All))/, vd = {children: !0, contents: !0, next: !0, prev: !0};
  f.extend({
    dir: function (g, a, b) {
      var c = [];
  ...
  f.fn.extend({
    has: function (g) {
      var a,
          b = f(g, this), c = b.length;
      return this.filter(function () {
        for (a = 0; a < c; a++) if (f.contains(this, b[a])) return !0
      })
    }, closest: function (g, a) {
      for (var b, c = 0, k = this.length, d = [], n = wc.test(g) || "string" !== typeof g ? f(g, a || this.context) : 0; c < k; c++) for (b = this[c]; b && b !== a; b = b.parentNode) if (11 > b.nodeType && (n ? -1 < n.index(b) : 1 === b.nodeType && f.find.matchesSelector(b, g))) {
        d.push(b);
        break
      }
  ...
  f.Callbacks = function (g) {
    ...
    var c, k, d, n, e, r, h = [], q = !g.once && [], j = function (a) {
      ...
      r = 0;
      n = h.length;
      for (c = !0; h && e < n; e++) if (!1 === h[e].apply(a[0],
          a[1]) && g.stopOnFalse) {
        k = !1;
        break
      }
  ...
  f.extend({
    Deferred: function (g) {
      var a = [["resolve", "done", f.Callbacks("once memory"), "resolved"],
            ["reject", "fail", f.Callbacks("once memory"), "rejected"], ["notify", "progress", f.Callbacks("memory")]],
          b = "pending", c = {
            state: function () {
              return b
            }, always: function () {
              ...
              return f.Deferred(function (b) {
                f.each(a, function (a, p) {
                  ...
                  k[p[1]](function () {
                    ...
                    if (g && f.isFunction(g.promise)) g.promise().done(b.resolve).fail(b.reject).progress(b.notify); else b[p[0] + "With"](this === c ? b.promise() :
                        this, v ? [g] : arguments)
                  })
                });
                g = null
      ...
      var a = 0, b = n.call(arguments), c = b.length, k = 1 !== c || g && f.isFunction(g.promise) ? c : 0,
          d = 1 === k ? g : f.Deferred(), e = function (g,
                                                        a, b) {
            return function (f) {
              a[g] = this;
  ...
  f.acceptData = function (g) {
    var a = f.noData[(g.nodeName + " ").toLowerCase()], b = +g.nodeType || 1;
    return 1 !== b && 9 !== b ? !1 : !a || !0 !== a && g.getAttribute("classid") === a
  };
  var Xc = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Wc = /([A-Z])/g;
  f.extend({
    cache: {}, noData: {
      "applet ": !0,
  ...
  f.extend({
    queue: function (g, a, b) {
      ...
      if (g) return a = (a || "fx") + "queue", c = f._data(g, a), b && (!c || f.isArray(b) ? c = f._data(g, a, f.makeArray(b)) : c.push(b)), c || []
                          ...
                          a) {
      a = a || "fx";
      var b = f.queue(g, a), c = b.length, k = b.shift(), d = f._queueHooks(g, a), n = function () {
        f.dequeue(g, a)
      };
  ...
  f.fn.extend({
    queue: function (g, a) {
      ...
      for (a = a || "fx"; e--;) if ((c = f._data(n[e], a + "queueHooks")) && c.empty) k++, c.empty.add(r);
      r();
      return d.promise(b)
    }
  });
  var zb = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Qa = ["Top", "Right", "Bottom", "Left"], hb = function (a, b) {
        a = b || a;
        return "none" === f.css(a, "display") || !f.contains(a.ownerDocument, a)
      }, Va = f.access = function (a, b, c, k, d, n, e) {
        var r = 0, h = a.length, q = null == c;
        if ("object" === f.type(c)) for (r in d = !0, c) f.access(a, b, r, c[r], !0, n, e); else if (void 0 !== k && (d = !0, f.isFunction(k) || (e = !0), q && (e ? (b.call(a, k), b = null) : (q = b, b = function (a, g, b) {
          return q.call(f(a), b)
        })), b)) for (; r < h; r++) b(a[r], c, e ? k : k.call(a[r],
            r, b(a[r], c)));
        return d ? a : q ? b.call(a) : h ? b(a[0], c) : n
      }, Mb = /^(?:checkbox|radio)$/i, Yb = y.createDocumentFragment(), Z = y.createElement("div"),
  ...
  var Yb = Z =
      nb = null, Ab, Bb, Ac = y.createElement("div");
  for (Ab in {
    submit: !0,
    change: !0,
    focusin: !0
  }) if (Bb = "on" + Ab, !(w[Ab + "Bubbles"] = Bb in a)) Ac.setAttribute(Bb, "t"), w[Ab + "Bubbles"] = !1 === Ac.attributes[Bb].expando;
  var Zb = /^(?:input|select|textarea)$/i, xd = /^key/, yd = /^(?:mouse|contextmenu)|click/,
      Bc = /^(?:focusinfocus|focusoutblur)$/, Cc = /^([^.]*)(?:\.(.+)|)$/;
  f.event = {
    global: {},
    add: function (a, b, c, k, d) {
      ...
      if (r = f._data(a)) {
        ...
        b = (b || "").match(xa) || [""];
        for (r = b.length; r--;) if (n = Cc.exec(b[r]) || [], A = j = n[1], z = (n[2] || "").split(".").sort(), A) {
          n = f.event.special[A] || {};
          ...
          j = f.extend({
              ...
              h);
          if (!(l = e[A])) if (l = e[A] = [], l.delegateCount = 0, !n.setup || !1 === n.setup.call(a, k, z, q)) a.addEventListener ? a.addEventListener(A, q, !1) : a.attachEvent && a.attachEvent("on" + A, q);
    ...
    remove: function (a, b, c, k, d) {
      ...
      if (m && (j = m.events)) {
        b = (b || "").match(xa) || [""];
        for (q = b.length; q--;) if (r = Cc.exec(b[q]) || [], z = t = r[1], T = (r[2] || "").split(".").sort(),
            z) {
          l = f.event.special[z] || {};
          z = (k ? l.delegateType : l.bindType) || z;
          A = j[z] || [];
          r = r[2] && RegExp("(^|\\.)" + T.join("\\.(?:.*\\.|)") + "(\\.|$)");
          for (h = n = A.length; n--;) if (e = A[n], (d || t === e.origType) && (!c || c.guid === e.guid) && (!r || r.test(e.namespace)) && (!k || k === e.selector || "**" === k && e.selector)) A.splice(n, 1), e.selector && A.delegateCount--, l.remove && l.remove.call(a, e);
          h && !A.length && ((!l.teardown || !1 === l.teardown.call(a, T, m.handle)) && f.removeEvent(a, z, m.handle), delete j[z])
        } else for (z in j) f.event.remove(a, z + b[q], c,
            k, !0);
        f.isEmptyObject(j) && (delete m.handle, f._removeData(a, "events"))
      }
    },
    trigger: function (g, b, c, k) {
      var d, n, e, r, h, q, j = [c || y], l = za.call(g, "type") ? g.type : g;
      h = za.call(g, "namespace") ? g.namespace.split(".") : [];
      e = d = c = c || y;
      if (!(3 === c.nodeType || 8 === c.nodeType) && !Bc.test(l + f.event.triggered)) if (0 <= l.indexOf(".") && (h = l.split("."), l = h.shift(), h.sort()), n = 0 > l.indexOf(":") && "on" + l, g = g[f.expando] ? g : new f.Event(l, "object" === typeof g && g), g.isTrigger = k ? 2 : 3, g.namespace = h.join("."), g.namespace_re = g.namespace ? RegExp("(^|\\.)" +
        ...
        for (q = 0; (e = j[q++]) && !g.isPropagationStopped();) if (g.type = 1 < q ? r : h.bindType || l, (d = (f._data(e, "events") || {})[g.type] && f._data(e, "handle")) &&
    ...
    dispatch: function (a) {
      ...
      if (!(h.preDispatch && !1 === h.preDispatch.call(this, a))) {
        ...
        for (b = 0; (k = e[b++]) && !a.isPropagationStopped();) {
          ...
          for (d = 0; (c = k.handlers[d++]) && !a.isImmediatePropagationStopped();) if (!a.namespace_re || a.namespace_re.test(c.namespace)) if (a.handleObj = c, a.data = c.data, c = ((f.event.special[c.origType] || {}).handle || c.handler).apply(k.elem, r), void 0 !== c && !1 === (a.result = c)) a.preventDefault(), a.stopPropagation()
        }
    ...
    handlers: function (a, b) {
      ...
      if (r && h.nodeType && (!a.button || "click" !== a.type)) for (; h != this; h = h.parentNode || this) if (1 === h.nodeType && (!0 !== h.disabled || "click" !== a.type)) {
        d = [];
  ...
  f.Event.prototype = {
    ...
    isImmediatePropagationStopped: q, preventDefault: function () {
  ...
  w.focusinBubbles || f.each({focus: "focusin", blur: "focusout"}, function (a, b) {
    var c = function (a) {
      f.event.simulate(b, a.target, f.event.fix(a), !0)
    };
    f.event.special[b] = {
      setup: function () {
        var k = this.ownerDocument || this, d = f._data(k, b);
        d || k.addEventListener(a, c, !0);
        f._data(k, b, (d || 0) + 1)
      }, teardown: function () {
        var k =
            this.ownerDocument || this, d = f._data(k, b) - 1;
  ...
  f.fn.extend({
    on: function (a, b, c, k, d) {
      ...
      if (!1 === k) k = q; else if (!k) return this;
  ...
  var mc = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
      zd = / jQuery\d+="(?:null|\d+)"/g, Dc = RegExp("<(?:" + mc + ")[\\s/>]", "i"), $b = /^\s+/,
      Ec = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Fc = /<([\w:]+)/, Gc = /<tbody/i,
      Ad = /<|&#?\w+;/, Bd = /<(?:script|style|link)/i, Cd = /checked\s*(?:[^=]|=\s*.checked.)/i,
      Hc = /^$|\/(?:java|ecma)script/i, Yc = /^true\/(.*)/, Dd = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, ka = {
  ...
  f.extend({
    clone: function (a, b, c) {
      ...
      if ((!w.noCloneEvent || !w.noCloneChecked) && (1 === a.nodeType || 11 === a.nodeType) && !f.isXMLDoc(a)) {
        ...
        for (e = 0; null != (d = r[e]); ++e) if (k[e]) {
          ...
          if (1 === q.nodeType) {
            ...
            if ("script" === l && q.text !== d.text) Ea(q).text = d.text, U(q); else if ("object" === l) q.parentNode && (q.outerHTML = d.outerHTML), w.html5Clone && (d.innerHTML && !f.trim(q.innerHTML)) && (q.innerHTML = d.innerHTML); else if ("input" === l && Mb.test(d.type)) q.defaultChecked = q.checked = d.checked, q.value !== d.value && (q.value = d.value); else if ("option" ===
      ...
      for (var d, n, e, r, h, q, l = a.length, j = B(b), A = [], z = 0; z < l; z++) if ((n = a[z]) || 0 === n) if ("object" === f.type(n)) f.merge(A, n.nodeType ? [n] : n); else if (Ad.test(n)) {
        ...
        if (!w.tbody) for (d = (n = "table" === r && !Gc.test(n) ? e.firstChild : "<table>" === q[1] && !Gc.test(n) ? e : 0) && n.childNodes.length; d--;) f.nodeName(h = n.childNodes[d], "tbody") && !h.childNodes.length && n.removeChild(h);
      ...
      for (z = 0; n = A[z++];) if (!(k && -1 !== f.inArray(n, k)) && (a = f.contains(n.ownerDocument, n), e = E(j.appendChild(n), "script"), a && Q(e), c)) for (d = 0; n = e[d++];) Hc.test(n.type || "") && c.push(n);
      return j
    }, cleanData: function (a, b) {
      for (var c, d, n, e, r = 0, h = f.expando, q = f.cache, l = w.deleteExpando, j = f.event.special; null != (c = a[r]); r++) if (b || f.acceptData(c)) if (e = (n = c[h]) && q[n]) {
        if (e.events) for (d in e.events) j[d] ? f.event.remove(c, d) : f.removeEvent(c, d, e.handle);
        q[n] && (delete q[n],
    ...
    text: function (a) {
      ...
      if (h && (n = f.buildFragment(a, this[0].ownerDocument, !1, this), c = n.firstChild, 1 === n.childNodes.length && (n = c), c)) {
        ...
        if (k) {
          ...
          f.map(d, U);
          for (e = 0; e < k; e++) if (c = d[e], Hc.test(c.type || "") && !f._data(c, "globalEval") && f.contains(n, c)) c.src ? f._evalUrl && f._evalUrl(c.src) : f.globalEval((c.text || c.textContent || c.innerHTML || "").replace(Dd, ""))
        }
        n = c = null
      }
      return this
  ...
  var Ic = /^margin/, sb = RegExp("^(" + zb + ")(?!px)[a-z%]+$", "i"), Ra, Sa, Ed = /^(top|right|bottom|left)$/;
  ...
  var dc = function () {
        ...
        c && (g = y.createElement("div"), b = y.createElement("div"),
            g.style.cssText = bc, c.appendChild(g).appendChild(b), b.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;display:block;padding:1px;border:1px;width:4px;margin-top:1%;top:1%", f.swap(c, null != c.style.zoom ? {zoom: 1} : {}, function () {
          cc = 4 === b.offsetWidth
        }), Db = !0, Eb = !1, Fb = !0, a.getComputedStyle && (Eb = "1%" !== (a.getComputedStyle(b, null) || {}).top, Db = "4px" === (a.getComputedStyle(b, null) || {width: "4px"}).width), c.removeChild(g), b = c = null)
      }, pb, Gb, cc, Db, Eb, Fb,
      bb = y.createElement("div"), bc = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px";
  ...
  var ec = /alpha\([^)]*\)/i, Fd = /opacity\s*=\s*([^)]*)/, Gd = /^(none|table(?!-c[ea]).+)/, Zc = RegExp("^(" +
      zb + ")(.*)$", "i"), Hd = RegExp("^([+-])=(" + zb + ")", "i"),
      Id = {position: "absolute", visibility: "hidden", display: "block"}, Jc = {letterSpacing: 0, fontWeight: 400},
      oc = ["Webkit", "O", "Moz", "ms"];
  f.extend({
    cssHooks: {
      opacity: {
    ...
    cssProps: {"float": w.cssFloat ? "cssFloat" : "styleFloat"},
    style: function (a, b, c, k) {
      if (a && !(3 === a.nodeType ||
        ...
        if (void 0 !== c) {
          ...
          if (!(null == c || c !== c)) if ("number" === n && !f.cssNumber[r] && (c += "px"), !w.clearCloneStyle && ("" === c && 0 === b.indexOf("background")) && (h[b] = "inherit"), !e || !("set" in e) || void 0 !== (c = e.set(a, c, k))) try {
            h[b] = "", h[b] = c
          } catch (q) {
          }
  ...
  w.opacity || (f.cssHooks.opacity = {
    get: function (a, b) {
      ...
      var c = a.style, k = a.currentStyle, d = f.isNumeric(b) ? "alpha(opacity=" + 100 * b + ")" : "",
          n = k && k.filter || c.filter || "";
      c.zoom = 1;
      if ((1 <= b || "" === b) && "" === f.trim(n.replace(ec, "")) && c.removeAttribute) if (c.removeAttribute("filter"),
      "" === b || k && !k.filter) return;
      c.filter = ec.test(n) ? n.replace(ec, d) : n + " " + d
    }
  });
  f.cssHooks.marginRight = fb(w.reliableMarginRight, function (a, b) {
    if (b) return f.swap(a, {display: "inline-block"}, Sa, [a, "marginRight"])
  });
  ...
  f.Tween = L;
  L.prototype = {
    constructor: L, init: function (a, b, c, k, d, n) {
      this.elem = a;
      this.prop = c;
      this.easing = d || "swing";
      this.options =
  ...
  L.propHooks = {
    _default: {
      get: function (a) {
        ...
        if (f.fx.step[a.prop]) f.fx.step[a.prop](a); else a.elem.style && (null != a.elem.style[f.cssProps[a.prop]] || f.cssHooks[a.prop]) ? f.style(a.elem, a.prop, a.now + a.unit) : a.elem[a.prop] = a.now
      }
    }
  };
  ...
  f.fx.step = {};
  var Za, Hb, Jd = /^(?:toggle|show|hide)$/, Kc = RegExp("^(?:([+-])=|)(" + zb + ")([a-z%]*)$", "i"),
      Kd = /queueHooks$/, tb = [function (a, b, c) {
        ...
        for (k in b) if (d = b[k], Jd.exec(d)) {
          delete b[k];
          n = n || "toggle" === d;
          if (d === (A ? "hide" : "show")) if ("show" === d && z && void 0 !== z[k]) A = !0; else continue;
          j[k] = z && z[k] || f.style(a, k)
        }
        if (!f.isEmptyObject(j)) for (k in z ? "hidden" in z && (A = z.hidden) : z = f._data(a, "fxshow", {}), n && (z.hidden = !A), A ? f(a).show() : q.done(function () {
          f(a).hide()
        }), q.done(function () {
          var b;
        ...
        "*": [function (a, b) {
          var c = this.createTween(a, b), k = c.cur(), d = Kc.exec(b), n = d && d[3] || (f.cssNumber[a] ? "" : "px"),
              e = (f.cssNumber[a] || "px" !== n && +k) && Kc.exec(f.css(c.elem, a)), r = 1, h = 20;
          if (e && e[3] !== n) {
            n = n || e[3];
            d = d || [];
            e = +k || 1;
  ...
  f.fn.extend({
    fadeTo: function (a, b, c, k) {
      return this.filter(hb).css("opacity", 0).show().end().animate({opacity: b}, a, c, k)
    }, animate: function (a, b, c, k) {
      var d = f.isEmptyObject(a), n = f.speed(b, c, k);
      b = function () {
      ...
      !1 !== a && this.queue(a || "fx", []);
      return this.each(function () {
        var b = !0, d = null != a && a + "queueHooks", n = f.timers, e = f._data(this);
        if (d) e[d] && e[d].stop && k(e[d]); else for (d in e) e[d] && (e[d].stop && Kd.test(d)) && k(e[d]);
        for (d = n.length; d--;) if (n[d].elem === this && (null == a || n[d].queue === a)) n[d].anim.stop(c), b = !1, n.splice(d, 1);
  ...
  f.extend({
    valHooks: {
      option: {
        ...
        get: function (a) {
          for (var b, c = a.options, k = a.selectedIndex, d = (a = "select-one" === a.type || 0 > k) ? null : [], n = a ? k + 1 : c.length, e = 0 > k ? n : a ? k : 0; e < n; e++) if (b = c[e], (b.selected || e === k) && (w.optDisabled ? !b.disabled : null === b.getAttribute("disabled")) && (!b.parentNode.disabled || !f.nodeName(b.parentNode, "optgroup"))) {
            b = f(b).val();
            if (a) return b;
            d.push(b)
          }
          ...
          for (var c, k, d = a.options,
                   n = f.makeArray(b), e = d.length; e--;) if (k = d[e], 0 <= f.inArray(f.valHooks.option.get(k), n)) try {
            k.selected = c = !0
          } catch (r) {
            k.scrollHeight
          } else k.selected = !1;
  ...
  var cb, Lc, Na = f.expr.attrHandle, hc = /^(?:checked|selected)$/i, Wa = w.getSetAttribute,
      Jb = w.input;
  f.fn.extend({
    attr: function (a, b) {
  ...
  f.extend({
    attr: function (a, b, c) {
      ...
      var c, k, d = 0, n = b && b.match(xa);
      if (n && 1 === a.nodeType) for (; c = n[d++];) k = f.propFix[c] || c, f.expr.match.bool.test(c) ? Jb && Wa || !hc.test(c) ? a[k] = !1 : a[f.camelCase("default-" + c)] = a[k] = !1 : f.attr(a, c, ""), a.removeAttribute(Wa ? c : k)
    }, attrHooks: {
      type: {
        set: function (a, b) {
  ...
  var Md = /^(?:input|select|textarea|button|object)$/i, Nd = /^(?:a|area)$/i;
  f.fn.extend({
    prop: function (a, b) {
  ...
  f.fn.extend({
    addClass: function (a) {
      var b,
          c, k, d, n, e = 0, r = this.length;
      b = "string" === typeof a && a;
      if (f.isFunction(a)) return this.each(function (b) {
        f(this).addClass(a.call(this, b, this.className))
      });
      if (b) for (b = (a || "").match(xa) || []; e < r; e++) if (c = this[e], k = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(ic, " ") : " ")) {
      ...
      if (b) for (b = (a || "").match(xa) || []; e < r; e++) if (c = this[e], k = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(ic, " ") : "")) {
        for (n = 0; d = b[n++];) for (; 0 <= k.indexOf(" " + d + " ");) k = k.replace(" " + d + " ", " ");
        k = a ? f.trim(k) : "";
        c.className !== k && (c.className = k)
      }
      return this
      ...
      return "boolean" === typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : f.isFunction(a) ? this.each(function (c) {
          ...
          this.each(function () {
            if ("string" === c) for (var b, k = 0, d = f(this), n = a.match(xa) || []; b = n[k++];) d.hasClass(b) ? d.removeClass(b) : d.addClass(b); else if (c === la || "boolean" === c) this.className && f._data(this, "__className__", this.className), this.className = this.className || !1 === a ? "" : f._data(this, "__className__") || ""
          })
    }, hasClass: function (a) {
      a = " " + a + " ";
      for (var b = 0, c = this.length; b < c; b++) if (1 === this[b].nodeType && 0 <= (" " + this[b].className + " ").replace(ic, " ").indexOf(a)) return !0;
      return !1
    }
  });
    ...
    active: 0, lastModified: {}, etag: {}, ajaxSettings: {
      ...
      function c (a, b, g, k) {
        ...
        if (2 !== ea) {
          ...
          if (g) {
            p = j;
            for (var v = s, N, ia, F, B, E = p.contents, P = p.dataTypes; "*" === P[0];) P.shift(), void 0 === ia && (ia = p.mimeType || v.getResponseHeader("Content-Type"));
            if (ia) for (B in E) if (E[B] && E[B].test(ia)) {
              P.unshift(B);
              break
            }
            if (P[0] in g) F = P[0]; else {
              for (B in g) {
          ...
          a:{
            ...
            ia = s;
            F = k;
            var w, Y, u, v = {}, E = g.dataTypes.slice();
            if (E[1]) for (Y in g.converters) v[Y.toLowerCase()] = g.converters[Y];
            for (B = E.shift(); B;) if (g.responseFields[B] && (ia[g.responseFields[B]] = N), !u && (F && g.dataFilter) && (N = g.dataFilter(N, g.dataType)), u = B, B = E.shift()) if ("*" === B) B = u; else if ("*" !== u && u !== B) {
              Y = v[u + " " + B] || v["* " + B];
              if (!Y) for (w in v) if (p = w.split(" "), p[1] === B && (Y = v[u + " " + p[0]] || v["* " + p[0]])) {
                !0 === Y ? Y = v[w] : !0 !==
                    v[w] && (B = p[0], E.unshift(p[1]));
                break
              }
              if (!0 !== Y) if (Y && g["throws"]) N = Y(N); else try {
                N = Y(N)
              } catch (K) {
                p = {state: "parsererror", error: Y ? K : "No conversion from " + u + " to " + B};
                break a
              }
            }
            p = {state: "success", data: N}
          }
          if (k) j.ifModified && ((I = s.getResponseHeader("Last-Modified")) && (f.lastModified[n] = I), (I = s.getResponseHeader("etag")) && (f.etag[n] = I)), 204 === a || "HEAD" === j.type ? I = "nocontent" : 304 === a ? I = "notmodified" : (I = p.state, d = p.data, l = p.error, k = !l); else if (l = I, a || !I) I = "error", 0 > a && (a = 0);
          s.status = a;
          s.statusText = (b || I) +
              "";
      ...
      b = b || {};
      var k, d, n, e, r, h, q, l, j = f.ajaxSetup({}, b), A = j.context || j,
          z = j.context && (A.nodeType || A.jquery) ? f(A) : f.event, T = f.Deferred(), t = f.Callbacks("once memory"),
          m = j.statusCode || {}, I = {}, N = {}, ea = 0, ia = "canceled", s = {
            readyState: 0, getResponseHeader: function (a) {
              var b;
              if (2 === ea) {
                if (!l) for (l = {}; b = Qd.exec(e);) l[b[1].toLowerCase()] = b[2];
                b = l[a.toLowerCase()]
              }
              ...
              var b;
              if (a) if (2 > ea) for (b in a) m[b] = [m[b], a[b]]; else s.always(a[s.status]);
              return this
            }, abort: function (a) {
              a = a || ia;
              q && q.abort(a);
  ...
  var Td = /%20/g, ad = /\[\]$/, Qc = /\r?\n/g, Ud = /^(?:submit|button|image|reset|file)$/i,
  ...
  var Wd = 0, Kb = {}, Lb = f.ajaxSettings.xhr();
    ...
    if (!a.crossDomain || w.cors) {
      ...
      return {
        send: function (c, k) {
          ...
          b = function (c, d) {
            var r, j, h;
            if (b && (d || 4 === n.readyState)) if (delete Kb[e], b = void 0, n.onreadystatechange = f.noop, d) 4 !== n.readyState && n.abort(); else {
              h = {};
              r = n.status;
  ...
  f.ajaxPrefilter("json jsonp", function (b, c, k) {
    var d, n, e,
        r = !1 !== b.jsonp && (lc.test(b.url) ? "url" : "string" === typeof b.data && !(b.contentType || "").indexOf("application/x-www-form-urlencoded") && lc.test(b.data) && "data");
  ...
  f.fn.load = function (a, b, c) {
    ...
    0 < e.length && f.ajax({url: a, type: n, dataType: "html", data: b}).done(function (a) {
      d = arguments;
  ...
  f.fn.extend({
    offset: function (a) {
      ...
      var b, c, k = {top: 0, left: 0}, d = (c = this[0]) && c.ownerDocument;
      if (d) {
        b = d.documentElement;
      ...
      if (this[0]) {
        ...
        return {top: b.top - c.top - f.css(k, "marginTop", !0), left: b.left - c.left - f.css(k, "marginLeft", !0)}
      }
  ...
  f.each({Height: "height", Width: "width"},
      function (a, b) {
        f.each({padding: "inner" + a, content: b, "": "outer" + a}, function (c, k) {
          f.fn[k] = function (k, d) {
  ...
  a.support.iecors ? a.ajaxTransport(function (a) {
    ...
    return {
      send: function (e, j) {
        ...
        h = function () {
          var b = t.status, c = "", d = t.getAllResponseHeaders(), e = {};
          try {
            if (h && 4 === t.readyState) {
              h = void 0;
              try {
...
(function (a, m) {
  ...
  var l = document, h = window, e = {};
  e.ua = navigator.userAgent.toLowerCase();
  var j;
  a:{
    j = ["linux", "unix", "mac", "win"];
    for (var t = j.length; t--;) if (-1 != e.ua.indexOf(j[t])) {
      j = j[t];
      break a
    }
    j = "unknown"
  ...
  e.os = j;
  e.browser = function () {
    for (var a = e.ua, c = "konqueror webkit omniweb opera webtv icab msie mozilla".split(" "), d = 0; d < c.length; d++) if (0 <= a.indexOf(c[d])) return c[d];
    return "unknown"
  };
  ...
  e.supportsLocalization = function () {
    for (var a = l.getElementsByTagName("meta"), c = a.length; 0 <= --c;) if (0 <= a[c].outerHTML.toLowerCase().indexOf("utf-8")) return !0;
    return !1
  };
  ...
  a._setInfo = function (a, c, d) {
    var e = [], j = "";
    if (0 == d.indexOf("ERROR")) j = d; else switch (c) {
      case "=":
  ...
  a.playAudio = function (a, c) {
    var d = c.get ? function (a) {
      return c.get(a)
    } : null, e = c.put ? function (a, b) {
      return c.put(a, b)
    } : null, j = d ? d("audioFile") : c, h = d && d("audioPlayer"), l = document.createElement("audio");
    e && e("audioElement", l);
    var t = null;
    h && (t = function (a) {
      h.processUpdate(a)
  ...
  a._getInfoFromDatabase = function (b, c, d) {
    if ("====" == c) {
      var e = a.db._restQueryXml.replace(/QUERY/, d), e = {
        dataType: "text",
        type: "POST",
  ...
  a._contactServer = function (b, c, d) {
    b = {
      dataType: "text", type: "GET", url: a._serverUrl + b, success: function (b) {
        a._loadSuccess(b, c)
      }, error: function () {
        a._loadError(d)
  ...
  a._setQueryTerm = function (b, c) {
    if (c && b._hasOptions && "http://" != c.substring(0, 7)) {
      if (a._isDatabaseCall(c)) {
        ...
        if (e && e.options) for (var j = 0; j < e.options.length; j++) e[j].value == d && (e[j].selected = !0)
      }
      a.$val(a.$(b, "query"), c)
    }
  };
  ...
  a._searchMol = function (b, c, d, e) {
    ...
    if (c && !(0 > h.indexOf("?") && h == b._thisJmolModel)) {
      b._thisJmolModel = h;
      var l;
      e && null != b._viewSet && null != (l = a.View.__findView(b._viewSet, {chemID: h})) ? a.View.__setView(l, b, !1) : ("$" == j || ":" == j ? b._jmolFileType = "MOL" : "=" == j && (b._jmolFileType = "PDB"), b._searchDatabase(c, j, d))
    }
  };
  ...
  a._getFileData = function (b, c, d) {
    ...
    j &&
    (b = b.replace(/\.gz/, ""), e = !1);
    var j = e && !c && !a._canSyncBinary(j), h = 0 <= b.indexOf("?POST?");
    ...
    var l = 0 > b.indexOf("://") || 0 == b.indexOf(document.location.protocol) && 0 <= b.indexOf(document.location.host),
        t = "https://" == a._httpProto && 0 == b.indexOf("http://"), m = a._isDirectCall(b);
    !m && 0 <= b.indexOf("?ALLOWSORIGIN?") && (m = !0, b = b.replace(/\?ALLOWSORIGIN\?/, ""));
    var s = !l && a.$supportsIECrossDomainScripting(), u = null;
    if (t || j || !l && !m || !c && s) u =
        a._getRawDataFromServer("_", b, c, c, j, !0); else {
      b = b.replace(/file:\/\/\/\//, "file://");
      var Q = {dataType: e ? "binary" : "text", async: !!c};
  ...
  a.loadFileAsynchronously = function (b, c, d, e) {
    ...
    a.$appEvent(c, "localReader_loadfile", "click", function () {
      var d = a.$(c, "localReader_files")[0].files[0], j = new FileReader;
  ...
  a._sortMessages = function (a) {
    ...
    for (var d = [], e = a.length - 1; 0 <= e; e--) for (var j = 0, h = a[e].length; j < h; j++) d[d.length] = a[e][j];
  ...
  a._gestureUpdate = function (b, c) {
    ...
    switch (c.type) {
      case "touchstart":
        ...
        break;
      case "touchmove":
        var e = a.$offset(b.id), j = b._touches[0], h = b._touches[1];
  ...
  a._jsSetMouse = function (b) {
    ...
    a.$bind(b, "DOMMouseScroll mousewheel", function (d) {
      ...
      d.preventDefault();
      b.isDragging = !1;
      var e = d.originalEvent, e = e.detail ? e.detail : ("mac" == a.featureDetection.os ? 1 : -1) * e.wheelDelta;
  ...
  s.click = function (b, c) {
    ...
    if (d) {
      var e = d.toString();
      if (0 <= e.indexOf("JCheck")) d.selected = b.checked; else if (0 <= e.indexOf("JCombo")) d.selectedIndex = b.selectedIndex; else if (null !=
  ...
  (function (b) {
    ...
    b.__findView = function (a, d) {
      ...
      for (var j = e.length; 0 <= --j;) {
        ...
        if (d.viewID) {
          ...
          for (var l in h) if ("info" != l && (null != d.data && null != h[l].data ? d.data == h[l].data : d.type == l)) return h
        }
      }
      return null
    };
    b.__createViewSet =
        function (c, d, e) {
          ...
          for (var j in a._applets) e = a._applets[j], e._viewSet == c && (d[e._viewType] = {applet: e, data: null});
          b.sets[c].push(d);
          return d
        };
    b.__setView = function (a, b, e) {
      for (var j in a) if ("info" != j) {
        var h = a[j], l = h.applet, t = e || null != l && "<modified>" == l._molData;
        if (!(null == l || l == b && !t)) {
          var m = null == h.data, s = null != l._currentView;
          l._currentView = a;
          if (!s || !(a[j].data == h.data && !m & !t)) if (l._loadModelFromView(a), m) break
        }
      }
    }
  })(a.View);
...
(function (a) {
  ...
  a._asyncCallbacks = {};
  a._coreFiles = [];
  var m = !1, l = [], h = [], e = 0, j = [], t = [], s = function (b) {
    arguments.length || (b = !0);
    delete e;
    for (var d; 0 < h.length && "done" == (d = h[0])[4];) h.shift();
    if (0 != h.length) if (!a._isAsync && !b) setTimeout(s, 10); else {
      d.push("done");
    ...
    m ? s() : (m = !0, LoadClazz(), b._noMonitor && (Clazz._LoaderProgressMonitor.showStatus =
        function () {
        }), LoadClazz = null, b.__Info.uncompressed && Clazz.loadClass(), Clazz._Loader.onGlobalLoaded = function () {
  ...
  a._addCoreFile = function (b, d, e) {
    ...
    if (!(0 <= j.join("").indexOf(b))) {
      ...
      if (e && (e = e.split(" "))) for (b = 0; b < e.length; b++) 0 > t.join("").indexOf(e[b]) && t.push(d + "/core/core" + e[b] + ".z.js");
  ...
  a._setAppletParams = function (b, d, e, j) {
    for (var h in e) if (!b || 0 <= b.indexOf(";" + h.toLowerCase() + ";")) null == e[h] || "language" == h && !a.featureDetection.supportsLocalization() || (j ? d.put(h, !0 === e[h] ? Boolean.TRUE : !1 === e[h] ? Boolean.FALSE : e[h]) : d[h] = e[h])
  };
  a._jsSetPrototype = function (b) {
    ...
    b._createCanvas2d = function () {
      ...
      var e = Math.round(b.width()), j = Math.round(b.height()), h = document.createElement("canvas");
      h.applet = this;
      this._canvas = h;
      h.style.width = "100%";
      h.style.height = "100%";
  ...
  a.repaint = function (b, e) {
    if (b && b._appletPanel) {
      var j = a.$(b, "appletdiv"), h = Math.round(j.width()), j = Math.round(j.height());
  ...
  a.loadImage = function (b, e, j, h, l, t) {
    var m = "echo_" + e + j + (h ? "_" + h.length : ""), s = a.getHiddenCanvas(b.vwr.html5Applet, m, 0, 0, !1, !0);
    if (null == s) {
      if (null == t) {
        t = new Image;
...
(function (a, m) {
  ...
  var l = a._Applet, h = a._Applet.prototype;
  l._get = function (e, j, h) {
    ...
    null == u && (h || !m ? u = {_jmolType: "none"} : m && (u = new l(e, j)));
  ...
  h._restoreState = function (e, j) {
    ...
    var h = this, l = h._applet && h._applet.viewer;
    switch (j) {
      case "setOptions":
        return function () {
          h.__startAppletJS(h)
      ...
      default:
        ...
        if (l && l.isScriptExecuting && l.isScriptExecuting()) {
          if (a._asyncCallbacks[e]) return System.out.println("...ignored"),
              1;
          var m = l.getEvalContextAndHoldQueue(l.eval), b = m.pc - 1;
          m.asyncID = e;
  ...
  h._scriptWait = function (a, j) {
    var h = this._scriptWaitAsArray(a), l = "";
    if (!j) for (var m = h.length; 0 <= --m;) for (var b = 0, c = h[m].length; b < c; b++) l += h[m][b] + "\n";
    return l
  };
  h._scriptEcho = function (a) {
    a = this._scriptWaitAsArray(a);
    for (var j = "", h = a.length; 0 <= --h;) for (var l = a[h].length; 0 <= --l;) "scriptEcho" == a[h][l][1] && (j += a[h][l][3] + "\n");
    return j.replace(/ \| /g, "\n")
  };
  h._scriptMessage = function (a) {
    a = this._scriptWaitAsArray(a);
    for (var j = "", h = a.length; 0 <= --h;) for (var l = a[h].length; 0 <= --l;) "scriptStatus" == a[h][l][1] && (j += a[h][l][3] + "\n");
    return j.replace(/ \| /g, "\n")
  };
...
(function (a) {
  ...
  m._menuSelected = function (a) {
    var h = a.value;
    if (void 0 != h) m._scriptExecute(a, m._scripts[h]); else {
      h = a.length;
      if ("number" == typeof h) for (var e = 0; e < h; ++e) if (a[e].selected) {
  ...
  m._cbClick = function (a) {
    m._control = a;
    var h = m._actions[a.id][0], e = m._actions[a.id][1];
  ...
  m._cbOver = function (a) {
    var h =
        m._actions[a.id][0], e = m._actions[a.id][1];
  ...
  m._getCheckbox = function (l, h, e, j, t, s, u) {
    ...
    ++m._checkboxCount;
    if (void 0 == h || null == h || void 0 == e || null == e) alert("jmolCheckbox requires two scripts"); else if (void 0 == j || null == j) alert("jmolCheckbox requires a label"); else return m._actions[s] = [m._addScript(b, h), m._addScript(b, e)], l = "</span>",
  ...
  m._getMenu = function (l, h, e, j, t) {
    ...
    if (null != s && "object" == s && h.length) {
      ...
      for (j = 0; j < u; ++j) {
        var b = h[j], s = typeof b, c = null, d = t = null;
  ...
  m._getRadioGroup = function (l, h, e, j, t, s) {
    var u = typeof h;
    if ("object" != u || null == u || !h.length) alert("invalid arrayOfRadioButtons"); else {
      void 0 != e && null != e || (e = "&#xa0; ");
      var b = h.length;
      ++m._radioGroupCount;
...
LoadClazz = function () {
  ...
  window["j2s.clazzloaded"] || (window["j2s.clazzloaded"] = !0, window["j2s.object.native"] = !0, Clazz = {
    ...
    a.extendJO = function (b, c) {
      ...
      if (a._supportsNativeObject) for (var d = 0; d < a._extendedObjectMethods.length; d++) {
    ...
    a.getClass = function (b) {
      ...
      if (b instanceof a.CastedNull) b = b.clazzName; else switch (typeof b) {
        case "string":
          return String;
        case "object":
    ...
    var t = function (b, c) {
      for (var d = 0; d < a.innerFunctionNames.length; d++) if (c == a.innerFunctionNames[d] && a._innerFunctions[c] === b[c]) return !0;
      return !1
    }, s = function () {
    };
    a.inheritArgs = new s;
    ...
    a.implementOf = function (a, b) {
      if (2 <= arguments.length) {
        ...
        var c = a.implementz;
        if (2 == arguments.length) if ("function" == typeof b) c.push(b), u(a, b); else {
          if (b instanceof Array) for (var d = 0; d < b.length; d++) c.push(b[d]), u(a, b[d])
        } else for (d = 1; d < arguments.length; d++) c.push(arguments[d]), u(a, arguments[d])
      }
    };
    var u = function (a, b) {
      for (var c in b) if ("b$" != c && "prototype" != c && "superClazz" != c && "__CLASS_NAME__" != c && "implementz" !=
          c && ("function" != typeof b[c] || !t(b, c))) a[c] = a.prototype[c] = b[c]
    };
    a.extendInterface = a.implementOf;
    a.equalsOrExtendsLevel = function (b, c) {
      if (b === c) return 0;
      if (b.implementz) for (var d = b.implementz, e = 0; e < d.length; e++) {
    ...
    a.getInheritedLevel = function (b, c) {
      ...
      d = 0;
      for (e = b; e !== c && 10 > d;) {
        if (e.implementz) for (var h = e.implementz, j = 0; j < h.length; j++) {
    ...
    a.superCall = function (b, c, d, e) {
      var h = null, j = -1,
          l = b[d];
      if (l) if (l.claxxOwner) l.claxxOwner !== c && (h = l); else if (!l.stacks && (!l.lastClaxxRef || !l.lastClaxxRef.prototype[d] || !l.lastClaxxRef.prototype[d].stacks)) h = l; else {
        var m = l.stacks;
        m || (m = l.lastClaxxRef.prototype[d].stacks);
        for (j = m.length; 0 <= --j;) if (c === m[j]) {
    ...
    try {
      ...
      if (j = function (a, b, c) {
        ...
        var j = d.message.indexOf(":"), q = d.message.indexOf(":", j + 2), I = d.message.substr(j + 1, q - j - 20);
        c = function (a) {
    ...
    a.getStackTrace = function (a) {
      ...
      try {
        for (var e = 0; e < a && (c = c.caller); e++) {
          ...
          if (d) for (var j = c.arguments, l = 0; l < j.length; l++) {
            var m = "" + j[l];
    ...
    a.defineMethod = function (c, d, h, j) {
      ...
      if (!m.stacks || m.claxxReference !== c) {
        ...
        m = function () {
          var c;
          a:{
            var d = arguments.callee.claxxReference, k = arguments.callee.methodName;
            c = arguments;
            fx = this[k];
            ...
            if (fx.lastParams == h.typeString && fx.lastClaxxRef === d) {
              ...
              for (var r = !1, l = j.length; 0 <= --l;) if (r || j[l] === d) {
                var m = j[l].prototype[k], z = h, r = c, s = fx, q = [], t = !0, F = void 0;
                for (F in m) if (92 == F.charCodeAt(0)) {
                ...
                if (!(F = 0 == q.length)) {
                  ...
                  for (var F = [], P = q.length, u = 0; u < P; u++) {
                    for (var x = [], za = !0, C = q[u].length, B = 0; B < C; B++) if (x[B] = a.getInheritedLevel(z[B], q[u][B]), 0 > x[B]) {
                      za = !1;
                      break
                    }
                    za && (x[z.length] = u, F.push(x))
                  }
                  if (0 == F.length) F = null; else {
                    P = F[0];
                    for (u = 1; u < F.length; u++) {
                      x = !0;
                      for (B = 0; B < z.length; B++) if (P[B] < F[u][B]) {
                        x = !1;
                        break
                      }
                      x && (P = F[u])
    ...
    var rb = function (a, b) {
      if (a && b) for (var c = a.length; 0 <= --c;) if (a[c] === b) return c;
      return -1
    }, Ya = function (a, b) {
      var c = rb(a, b);
      if (0 <= c) {
    ...
    a.getParamsType = function (b) {
      ...
      d = [];
      d.hasCastedNull = !1;
      if (b) for (var e = 0; e < c; e++) d[e] = a.getClassName(b[e]), b[e] instanceof a.CastedNull && (d.hasCastedNull = !0);
      d.typeString = "\\" + d.join("\\");
      return d
    };
    var Q = 0;
    ...
    a.declarePackage = function (b) {
      ...
      if (b && b.length) {
        for (var c = b.split(/\./), d = a.allPackage, e = 0; e < c.length; e++) d[c[e]] || (d[c[e]] = {__PKG_NAME__: d.__PKG_NAME__ ? d.__PKG_NAME__ + "." + c[e] : c[e]}, 0 == e && a.setGlobal(c[e], d[c[e]])), d = d[c[e]];
        a.lastPackageName = b;
    ...
    a.evalType = function (b, c) {
      var d = b.lastIndexOf(".");
      if (-1 != d) {
        var e = b.substring(0, d), e =
            a.declarePackage(e), d = b.substring(d + 1);
        return e[d]
      }
    ...
    a.defineType = function (b, c, d, e) {
      ...
      h = b.lastIndexOf(".");
      if (-1 != h) {
        var j = b.substring(0, h), j = a.declarePackage(j), h = b.substring(h +
            1);
        if (j[h]) return j[h];
        j[h] = c
      } else {
    ...
    var Fa = !1;
    -1 != navigator.userAgent.indexOf("Safari") && (j = navigator.userAgent, q = j.indexOf("Version/"), -1 != q && (j = j.substring(q + 8), Fa = 4 <= parseFloat(j)));
    ...
    a._innerFunctions = {
      ...
      getClassLoader: function () {
        var b = this.__CLASS_NAME__, c = a._Loader.getClasspathFor(b), d = c.lastIndexOf(b.replace(/\./g, "/")),
            c = -1 != d ? c.substring(0, d) : a._Loader.getClasspathFor(b, !0), b = a._Loader.requireLoaderByBase(c);
        ...
        if (!b) return null;
        b = b.replace(/\\/g, "/");
        var c = null, d = b, d = this.__CLASS_NAME__;
        2 == arguments.length && 0 != b.indexOf("/") && (b = "/" + b);
        if (0 == b.indexOf("/")) if (2 == arguments.length ? (c = arguments[1]) || (c = a.binaryFolders[0]) : a._Loader && (c = a._Loader.getClasspathFor(d, !0)), c) {
          var c = c.replace(/\\/g, "/"), e = c.length, e = c.charAt(e - 1);
          "/" != e && (c += "/");
          d = c + b.substring(1)
        } else d = b.substring(1); else {
          if (this.base) c = this.base; else if (a._Loader) if (c = a._Loader.getClasspathFor(d), e = c.lastIndexOf(d.replace(/\./g, "/")), -1 != e) c = c.substring(0, e); else if (e = -1, c.indexOf(".z.js") == c.length - 5 && -1 != (e = c.lastIndexOf("/"))) for (var c =
          ...
          } else c = a._Loader.getClasspathFor(d, !0); else (e = a.binaryFolders) && e.length && (c = e[0]);
          c || (c = "j2s/");
          c = c.replace(/\\/g, "/");
          e = c.length;
          e = c.charAt(e - 1);
    ...
    a.decorateAsType = function (b, c, d, e, h, j) {
      ...
      if (j) for (c = 0; c < a.innerFunctionNames.length; c++) j = a.innerFunctionNames[c], b[j] = a._innerFunctions[j];
    ...
    a.innerTypeInstance = function (b, c, d) {
      ...
      var e;
      if (d || c.$finals) if (e = new b(c, a.inheritArgs), d) if (c.f$) {
        var h = {}, j;
        for (j in c.f$) h[j] = c.f$[j];
        for (j in d) h[j] = d[j];
        e.f$ = h
      } else e.f$ = d; else c.f$ && (e.f$ = c.f$); else switch (arguments.length) {
        case 3:
          return new b(c);
        case 4:
    ...
    a.isClassDefined = a.isDefinedClass = function (b) {
      ...
      for (var c = b.split(/\./), d = null, e = 0; e < c.length; e++) if (!(d = d ? d[c[e]] : a.allPackage[c[0]])) return !1;
    ...
    var gb = function (a, b) {
      a || (a = 0);
      if ("object" == typeof a) var c = a; else for (var c = Array(a), d = 0; d < a; d++) c[d] =
          0;
    ...
    a.defineStatics = function (a) {
      for (var b = arguments.length, c = (b - 1) / 2; 0 <= --c;) {
        var d = arguments[--b], e = arguments[--b];
        a[e] = a.prototype[e] = d
      }
    };
    a.prepareFields = function (a, b) {
      var c = [];
      if (a.con$truct) for (var d = a.con$truct.stacks, e = 0; e < d.length; e++) c[e] = d[e];
    ...
    java.lang.System = System = {
      props: null, $props: {}, arraycopy: function (a, b, c, d, e) {
        if (a !== c || b > d) for (; 0 <= --e;) c[d++] = a[b++]; else {
          d += e;
          for (b += e; 0 <= --e;) a[--d] = a[--b]
        }
    ...
    a._innerFunctions.getDeclaredMethod = a._innerFunctions.getMethod = function (a) {
      ...
      for (c in b) if (a == c && "function" == typeof b[c] && !b[c].__CLASS_NAME__) return new java.lang.reflect.Method(this, c, [], java.lang.Void, [], java.lang.reflect.Modifier.PUBLIC);
      b = this;
    ...
    (function (a, b) {
      ...
      var d = new x, e = {}, h = 0, j = 6, l = navigator.userAgent.toLowerCase(), q = -1 != l.indexOf("opera"),
          s = -1 != l.indexOf("msie") && !q, f = -1 != l.indexOf("gecko");
      ...
      var C = function (a) {
        ...
        for (var b = null, c = 0; c < a.length; c++) if (a[c]) {
          if ("$" == a[c].charAt(0)) if ("." == a[c].charAt(1)) {
            if (!b) continue;
            var d = b.lastIndexOf(".");
            -1 != d && (b = b.substring(0, d), a[c] = b + a[c].substring(1))
      ...
      b.loadPackageClasspath =
          function (a, c, d, e, f, h) {
            ...
            if (a instanceof Array) if (C(a), e) h < a.length ? b.loadPackageClasspath(a[h], c, d, function () {
              b.loadPackageClasspath(a, c, d, e, 1, h + 1)
            }, 1) : e(); else for (j = 0; j < a.length; j++) b.loadPackageClasspath(a[j], c, d, null); else {
              switch (a) {
                case "java.*":
                  a = "java";
                case "java":
      ...
      b.loadClass = function (c, f, h, j, l) {
        ...
        b.keepOnLoading = !0;
        if (!h && (I && c.lastIndexOf(".package") != c.length - 8 || 0 != c.indexOf("java.") && !isClassDefined(da))) La.push([c, f]), System.out.println("loadclass-queuing" + c + da + " " + isClassDefined(da)); else if ((l = isClassDefined(c)) || O["@" + c]) {
          if (l && f && (h = H(c), !h || h.status >= x.STATUS_LOAD_COMPLETE)) j ? window.setTimeout(f, 25) : f()
        } else {
          var m =
              b.getClasspathFor(c);
          l = e[m];
          if (!l) for (j = E.length; 0 <= --j;) if (E[j].path == m || E[j].name == c) {
            l = !0;
            break
          }
          if (l) {
            if (f && (l = H(c))) if (l.onLoaded) {
              if (f != l.onLoaded) {
                var r = l.onLoaded, q = f;
                l.onLoaded = function () {
                  r();
                  q()
                }
            ...
            c = !1;
            for (j = E.length; 0 <= --j;) if (E[j].status != x.STATUS_LOAD_COMPLETE) {
              c = !0;
              break
            }
            if (l.isPackage) {
      ...
      var V = function (c,
      ...
      }, ha = !0, ga = !1, ta = function (c, f) {
        var l = L["@" + c];
        if (l) {
          var m, r = D["$" + c];
          if (r) for (var q = 0; q < r.length; q++) {
            var t =
                r[q];
            if (t != l.name && (m = H(t))) m.status < x.STATUS_CONTENT_LOADED && (m.status = x.STATUS_CONTENT_LOADED, updateNode(m)); else {
              m = new x;
              m.name = t;
              var u = D["#" + t];
          ...
          if (b.keepOnLoading) {
            q = !0;
            if (m = Ka(x.STATUS_KNOWN)) for (S(m); h < j && (m = Ka(x.STATUS_KNOWN));) S(m); else if (0 != E.length) m = E.shift(), !e[m.path] || 0 != E.length || !ha || m.musts.length || m.optionals.length ? (Ja(d, m, !0), V(m, m.path,
                m.requiredBy, !1)) : ha && (ha = !1); else if (m = G(x.STATUS_KNOWN)) for (S(m); h < j && (m = G(x.STATUS_KNOWN));) S(m); else q = !1;
            if (!(q || 0 < h)) {
              l = [Ka, G];
              r = null;
              for (q = 0; 2 > q; q++) for (; m = l[q](x.STATUS_CONTENT_LOADED);) 1 == q && r === m && (m.status = x.STATUS_LOAD_COMPLETE), updateNode(m), r = m;
              for (; !(ma = [], !na(d, c));) ;
              for (q = 0; 2 > q; q++) for (r = null; (m = l[q](x.STATUS_DECLARED)) && r !== m;) updateNode(r = m);
              r = [];
              for (q = 0; 2 > q; q++) for (; m = l[q](x.STATUS_DECLARED);) r.push(m), m.status = x.STATUS_LOAD_COMPLETE;
              if (r.length) {
                for (q = 0; q < r.length; q++) Da(r[q]);
                for (q = 0; q < r.length; q++) if (l = r[q].onLoaded) r[q].onLoaded = null, l()
              }
              if (f) f(); else if (b._classCountPending) for (t in b._classPending) {
        ...
        for (h = 0; 2 > h; h++) {
          k = j[h];
          for (f = k.length; 0 <= --f;) if (k[f].status == x.STATUS_DECLARED && na(k[f], c)) return !0
        }
        d.length = e;
        return !1
      };
      ...
      updateNode = function (a) {
        if (!a.name ||
            a.status >= x.STATUS_LOAD_COMPLETE) Da(a); else {
          var c = !0;
          if (a.musts.length && a.declaration) for (var d = a.musts.length, e = d; 0 <= --e;) {
            var f = a.musts[e];
            f.requiredBy = a;
            if (f.status < x.STATUS_DECLARED && isClassDefined(f.name)) {
              ...
              f.onLoaded &&
              h.push(f);
              for (j = 0; j < h.length; j++) if (k = h[j].onLoaded) h[j].onLoaded = null, k()
          ...
          if (c) {
            if (a.status < x.STATUS_DECLARED) {
              ...
              if (a.declaration && a.declaration.clazzList) {
                ...
                for (l = k.length; j < l; j++) if ((m = H(k[j])) && m.status != x.STATUS_DECLARED && m !== a) m.status = x.STATUS_DECLARED, B && (B[m.name] = !0), b.onScriptInitialized(m.path)
              }
            }
            c = x.STATUS_DECLARED;
            if (0 == a.optionals.length && 0 == a.musts.length || a.status > x.STATUS_KNOWN && !a.declaration || Ta(a.musts, x.STATUS_LOAD_COMPLETE) && Ta(a.optionals, x.STATUS_LOAD_COMPLETE)) {
              ...
              if (a.declaration && a.declaration.clazzList) {
                j = 0;
                k = a.declaration.clazzList;
                for (l = k.length; j < l; j++) if ((m =
                    H(k[j])) && m.status != c && m !== a) if (m.declaration = null, !wa(m, c)) return !1
              }
            }
      ...
      var Ta = function (a, b) {
        ...
        if (a) for (var c = d.random, e = 0; e < a.length; e++) {
          var f = a[e];
      ...
      var X = function (a, b, c) {
        var d = "@" + a;
        if (a = L[d]) if (a instanceof Array) {
          for (var d = !1, e = 0; e < a.length; e++) if (a[e].name == b) {
            d = !0;
            break
          }
          d || a.push(c)
        } else L[d] = [a, c]; else L[d] = c;
        L["#" + b] = c
      }, S = function (a) {
        var c = a.name;
        ...
        return !1
      }, da = b.runtimeKeyClass = "java.lang.String", La = [];
      ...
      var Fa = {}, Pa = [], Ja = function (a, b, c) {
            var e = !1;
            c ? (c = a.musts, b.requiredBy || (b.requiredBy = a)) : c = a.optionals;
            Fa[b.name] || (Pa.push(b), Fa[b.name] = b);
            for (var f = 0; f < c.length; f++) if (c[f].name == b.name) {
              e = !0;
              break
            }
            e || (c.push(b), ha && (0 != b.name.indexOf("java") && 0 != b.name.indexOf("net.sf.j2s.ajax")) && (ga && (ha = !1), ga = !0));
            a:{
              if (a.name && a != d && a != b) for (e = 0; e < b.parents.length; e++) if (b.parents[e].name == a.name) break a;
              b.parents.push(a)
            }
          },
          Da = function (a) {
            var b = a.parents;
            if (b) for (var c = b.length; 0 <= --c;) Ya(b[c].musts, a) || Ya(b[c].optionals, a)
          };
      a.binaryFolders = b.binaryFolders = [b.getJ2SLibBase()]
    })(a, a._Loader);
    a._LoaderProgressMonitor = {};
    var aa = a._LoaderProgressMonitor, L = null, ga = 0, O = null, wa = 0;
    ...
    var jb = function (a) {
      if (a) for (var b = a.childNodes.length; 0 <= --b;) {
    ...
    var V = String.fromCharCode(160), V = V + (V + V + V);
    C.consoleOutput = function (a, b) {
      ...
      for (var h = a.split(/\r\n|\r|\n/g), d = 0, j = h.length - 1; d <= j; d++) {
        var l = null;
        if (C.metLineBreak || 0 == C.linesCount || 1 > c.childNodes.length) l = document.createElement("DIV"), c.appendChild(l), l.style.whiteSpace = "nowrap", C.linesCount++; else try {
